...
const AdminMenuItem: React.FC<AdminMenuItemProps> = ({ icon, title, href }) => {
  return (
    <Link href={href} className="flex justify-between pr-5 transition ease-in-out duration-300 delay-150 hover:bg-white hover:text-black hover:cursor-pointer">
