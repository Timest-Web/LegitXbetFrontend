          ...
          <BettorLayout
            content={
              <div className="text-sm">
                <p className="font-bold">{bettor.bettor} Mail Update</p>
                <form className="space-y-4">
                <label className="font-bold flex flex-col mt-3">
                 Send to
                    <input placeholder={bettor.email} className="p-3 w-[90%] bg-gray-200 rounded-sm" />
                  </label>
                  <label className="font-bold flex flex-col mt-3">
                    Name
                    <input placeholder={bettor.bettor} className="p-3 w-[90%] bg-gray-200 rounded-sm" />
                  </label>
                  <label className="font-bold flex flex-col mt-3">
                   Subject
