        ...
        <form className=" flex space-x-16 ">
          <section className="flex flex-col space-y-12">
            <div className="flex flex-col space-y-2">
              ...
              <input className="bg-[#ECEEF1] w-[19.0625rem] h-[2.8125rem] p-2 rounded" type="text" placeholder="e.g bayo ojo"></input>
            </div>
            <div className="flex flex-col space-y-2">
              <label className="font-bold pl-4">Date of birth</label>
              <input className="bg-[#ECEEF1] w-[19.0625rem] h-[2.8125rem] p-2 rounded" placeholder="23/04/1997"></input>
            </div>
            <div className="flex flex-col space-y-2">
              <label className="font-bold pl-4">Email</label>
              <input className="bg-[#ECEEF1] w-[19.0625rem] h-[2.8125rem] p-2 rounded" type="email" placeholder="johnpaul@gmail.com" ></input>
            </div>
          </section>
          <section className="flex flex-col ">
            ...
            <button className="bg-black text-white  w-[7.1875rem] h-[2.4375rem] text-[15px] rounded font-medium mt-[6.5rem] ">
              Save & Update
            </button>
          </section>
        </form>
