...
const LiveChat: React.FC<LiveChatProps> = ({ handleCloseModal }) => {
    ...
    const handleSendMessage = () => {
        // Replace the console.log with the actual logic to send the message
        ...
        <div className="bg-white w-full rounded-[1.25rem] px-6 py-2 md:p-6 mt-4">
            ...
            <section className="relative">
                ...
                <textarea
                    ...
                    className="text-sm text-center md:w-[30vw] md:h-[25vh] w-[80vw] h-[30vh] p-5 bg-[#F5F5F5] flex justify-center items-center"
                    placeholder="This is the beginning of your session with Oliade"
                ></textarea>
                <button
                    onClick={handleSendMessage}
                    className="absolute bottom-4 right-2 w-[8.25rem] h-[2.1875rem] border-[#5D5D5D] border rounded-md text-sm"
                >
                    Send response
                </button>
            </section>
