...
const OverviewWelcomeTab = () => {
  return (
    <div className="md:pl-9">
      <div className="flex h-24 md:h-auto w-72 rounded-lg space-x-4 md:bg-none md:bg-opacity-0 md:rounded-none md:p-0  md:flex-row md:space-y-0 text-sm md:space-x-6 mb-5">
