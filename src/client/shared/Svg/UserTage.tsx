...
const UserTage = () => {
  return (
		<svg
			...
			<path
				opacity='0.4'
				d='M10 8.33332C11.0724 8.33332 11.9417 7.464 11.9417 6.39164C11.9417 5.31929 11.0724 4.45001 10 4.45001C8.92768 4.45001 8.05835 5.31929 8.05835 6.39164C8.05835 7.464 8.92768 8.33332 10 8.33332Z'
				stroke='#E6EAEE'
				stroke-width='1.5'
				stroke-linecap='round'
				stroke-linejoin='round'
			...
			<path
				opacity='0.4'
				d='M13.3334 13.05C13.3334 11.55 11.8417 10.3334 10.0001 10.3334C8.15841 10.3334 6.66675 11.55 6.66675 13.05'
				stroke='#E6EAEE'
				stroke-width='1.5'
				stroke-linecap='round'
				stroke-linejoin='round'
