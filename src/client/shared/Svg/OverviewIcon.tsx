const OverviewIcon = () => {
  return (
    ...
    >
      ...
      <path
        opacity="0.34"
        d="M14.9998 18.3334C16.8408 18.3334 18.3332 16.841 18.3332 15C18.3332 13.1591 16.8408 11.6667 14.9998 11.6667C13.1589 11.6667 11.6665 13.1591 11.6665 15C11.6665 16.841 13.1589 18.3334 14.9998 18.3334Z"
        stroke="#292D32"
        stroke-width="1.5"
        stroke-miterlimit="10"
        stroke-linecap="round"
